...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    private void drawTextFields(Group root) {
        ...
        for (int xIndex = 0; xIndex < 9; xIndex++) {
            for (int yIndex = 0; yIndex < 9; yIndex++) {
                int x = xOrign + xIndex * xAndYDelta;
                int y = yOrign + yIndex * xAndYDelta;
    ...
    private void drawTitle(Group root) {
        Text tittle = new Text(235, 690, SUDOKU);
        tittle.setFill(Color.WHITE);
        Font tittleFont = new Font(43);
        tittle.setFont(tittleFont);
        root.getChildren().addAll(tittle);
    }
    ...
    public void updateBoard(SudokuGame game) {
        for (int xIndex = 0; xIndex < 9; xIndex++) {
            for (int yIndex = 0; yIndex < 9; yIndex++) {
                ...
                String value = Interger.toStringg(
